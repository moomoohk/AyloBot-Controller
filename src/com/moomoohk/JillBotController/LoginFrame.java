...
public class LoginFrame extends JFrame
{
	...
	public LoginFrame()
	{
		...
		lblLoginToTwitch.setFont(new Font("PT Sans", Font.PLAIN, 30));
		...
		sl_contentPane.putConstraint(SpringLayout.EAST, lblLoginToTwitch, 430, SpringLayout.WEST, this.contentPane);
		...
		lblUsername.setFont(new Font("PT Sans", Font.PLAIN, 13));
		...
		this.txtUsername.setFont(new Font("PT Sans", Font.PLAIN, 13));
		...
		lblPassword.setFont(new Font("PT Sans", Font.PLAIN, 13));
		...
		this.pwdOAuthToken.setFont(new Font("PT Sans", Font.PLAIN, 13));
		...
		sl_contentPane.putConstraint(SpringLayout.EAST, this.btnSubmit, 430, SpringLayout.WEST, this.contentPane);
		...
		sl_contentPane.putConstraint(SpringLayout.WEST, lblHelp, 238, SpringLayout.WEST, lblLoginToTwitch);
		sl_contentPane.putConstraint(SpringLayout.SOUTH, lblHelp, -3, SpringLayout.SOUTH, this.contentPane);
		sl_contentPane.putConstraint(SpringLayout.EAST, lblHelp, 430, SpringLayout.WEST, this.contentPane);
		lblHelp.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));
		lblHelp.setHorizontalAlignment(SwingConstants.RIGHT);
		lblHelp.setFont(new Font("PT Sans", Font.ITALIC, 13));
